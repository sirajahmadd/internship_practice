// 1.Create a mini project in Java that models a simple online shopping system. The system should allow users to view products, add them to a shopping cart, and check out. The project should utilize inheritance, interfaces, overriding, collections, and custom exceptions.
...
// This mini project in Java models a simple online shopping system that allows users to view products, add them to a shopping cart, and check out. The project utilizes inheritance, interfaces, overriding, collections, and custom exceptions to achieve this functionality.

// The project defines an interface called "Product" that defines the basic properties of a product such as the name, description, price, and quantity. It also defines two classes that implement the "Product" interface: "ElectronicProduct" and "ClothingProduct". The "ElectronicProduct" class has additional properties such as brand and warranty, while "ClothingProduct" has additional properties such as size and color.

// The project also includes a class called "ShoppingCart" that stores the products selected by the user and a class called "Checkout" that handles the payment and shipping of the products in the shopping cart. Custom exceptions are used to handle cases such as insufficient stock or invalid payment information.

// Additional features such as search have been implemented to enhance the user experience. Overall, this project provides a basic framework for implementing an online shopping system in Java.
...
class ShoppingCartt {
  ...
  public static void main(String args[]) {
    ...
    Scanner s = new Scanner(System.in);
    ShoppingCartt mini = new ShoppingCartt();
