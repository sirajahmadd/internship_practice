...
//abstract:
// This program models a School system with Teachers and Students as its core entities. The Teacher class has private fields for the teacher's name and subject, with corresponding getters and setters. The Student class has private fields for the student's name and grade level, with corresponding getters and setters. The School class has private fields for the list of Teachers and Students, and it provides methods to add and remove Teachers and Students, as well as print their lists. Additionally, it allows users to find and remove a Teacher or Student by name. The program has a main method that enables users to interact with the School object and perform the above actions until they choose to exit. This program serves as a basic model for a school system, providing users with a simple interface to manage Teachers and Students.
