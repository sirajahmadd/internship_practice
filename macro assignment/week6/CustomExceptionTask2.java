...
class Rectangle{
  ...
  void validateRectagleArea(int l,int b) throws InvalidDimensionsException{
    if(l<=0 && b<=0){
      throw new InvalidDimensionsException("enter proper length and bredth");
    }
    else{
      area=l*b;
  ...
  void validateRectanglePerimeter(int l,int b) throws InvalidDimensionsException{
    if(l<=0 && b<=0){
      throw new InvalidDimensionsException("enter corrrect length and bredth");
    }
    else{
      perimeter=2*(l+b);
